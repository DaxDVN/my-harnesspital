...
Usage:
    python scripts/harness_quality_gate.py --self-test
    python scripts/harness_quality_gate.py check-main-brain
    python scripts/harness_quality_gate.py validate-reuse <file>
    python scripts/harness_quality_gate.py validate-fix-plan <file>
    python scripts/harness_quality_gate.py validate-regression <file>
    python scripts/harness_quality_gate.py validate-review <findings.md> [--require-adjudicated]
"""
...
def self_test() -> int:
    ...
    print("harness_quality_gate self-test: OK")
    return 0
