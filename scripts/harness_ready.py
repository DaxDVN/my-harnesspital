...
CHECKS = [
    ...
    ("quality-gate-selftest", [sys.executable, "scripts/harness_quality_gate.py", "--self-test"]),
    ...
    ("lifecycle-eval-selftest", [sys.executable, "scripts/harness_lifecycle_eval.py", "--self-test"]),
    ...
    ("lifecycle-eval-scan", [sys.executable, "scripts/harness_lifecycle_eval.py", "scan"]),
