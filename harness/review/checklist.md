...
- **Sources:** `harness/rules/backend-rules-conventions-patterns.md`, `myhospital-be/CONVENTIONS.md`.
...
- **Sources:** `harness/rules/frontend-rules-conventions-patterns.md`, `myhospital-fe/CLAUDE.md`.
