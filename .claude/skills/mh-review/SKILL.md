...
Run the harness. The cross-tool review knowledge lives in **`harness/review/`** (neutral — Codex/opencode read it natively too): **[protocol.md](harness/review/protocol.md)** (the ≤3-round runbook), **[checklist.md](harness/review/checklist.md)** (10 dimensions D1–D10), **[findings-schema.md](harness/review/findings-schema.md)** (output format). This skill (`SKILL.md` + `workflow.js`) is the Claude driver. Full rationale: `docs/harness/notes/review-harness-feasibility-2026-06-16.md`.
...
- Inject into its prompt: the dimension id+name, the scope file-list, and "read your dimension's entry in harness/review/checklist.md".
