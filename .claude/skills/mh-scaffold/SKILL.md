...
> context / inline schema. Canon: `harness/rules/frontend-rules-conventions-patterns.md`.
...
Convention source of truth: `harness/rules/backend-rules-conventions-patterns.md` (BE),
`harness/rules/frontend-rules-conventions-patterns.md` (FE).
