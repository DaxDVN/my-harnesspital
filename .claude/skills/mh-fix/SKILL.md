...
Source-of-truth bundle: [`harness/review/protocol.md`](harness/review/protocol.md) · [`harness/review/findings-schema.md`](harness/review/findings-schema.md) · [`harness/review/checklist.md`](harness/review/checklist.md) · `AGENTS.md` Forbidden Actions.
...
Then re-check the **relevant checklist dimension(s)** (`harness/review/checklist.md` D1–D10) on the diff only — not the whole scope. Confirm:
...
2. **Convention gap?** → propose an addition to `harness/rules/backend-rules-conventions-patterns.md` or `harness/rules/frontend-rules-conventions-patterns.md` — shifts the error left to implementers.
3. **New dimension pattern?** → propose a "Known bug-class" line in `harness/review/checklist.md` under the correct D1–D10 dimension (with `file:line` exemplar if available) — raises Round-1 recall for future modules.
